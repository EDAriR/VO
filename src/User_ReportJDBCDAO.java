...
public class User_ReportJDBCDAO implements User_ReportDAO_interface {
	...
	public void delete(String mem_no_ed) {
		...
		try {
			...
			System.out.println("刪除商品類別編號" + mem_no_ed + "時,共有商品" + updateCount_PRODUCTs + "個同時被刪除");
...
//		user_ReportVO1.setUrpt_rsn("財務部回來嚕");
//		user_ReportVO1.setUrpt_is_cert("0");
//		user_ReportVO1.setUrpt_unrsn("財務部回來嚕");
